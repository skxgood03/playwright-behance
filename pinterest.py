...
if __name__ == "__main__":
    ...
    try:
        ...
        if not results:
            ...
            # # 保存结果
            # with open('pinterest_results.json', 'w', encoding='utf-8') as f:
            #     json.dump(results, f, ensure_ascii=False, indent=2)
            #
            # print(f"\nTotal results collected and saved: {len(results)}")
            # print("Results have been saved to 'pinterest_results.json'")
